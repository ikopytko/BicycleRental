...
public class DateFragment extends Fragment
{
    ...
    {
        void onDateChanged(String tabTag, int year, int month, int day);
    }
     ...
     */
    public static final DateFragment newInstance(String tabTag, int theme, int year, int month,
            int day, Date minDate, Date maxDate)
    {
        DateFragment f = new DateFragment();

        Bundle b = new Bundle();
        b.putString("tabTag", tabTag);
    ...
    {
        tabTag = getArguments().getString("tabTag");
        ...
        mDatePicker.init(
            ...
            new OnDateChangedListener() {
                ...
                {
                    mCallback.onDateChanged(tabTag, year, monthOfYear, dayOfMonth);
                }
            });
