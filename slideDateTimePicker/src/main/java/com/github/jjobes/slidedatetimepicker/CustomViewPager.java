...
public class CustomViewPager extends ViewPager {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mFromDatePicker = (DatePicker) findViewWithTag(SlideDateTimeDialogFragment.FROM_TAB_TAG);
        mToDatePicker = (DatePicker) findViewWithTag(SlideDateTimeDialogFragment.TO_TAB_TAG);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        switch (getCurrentItem()) {
            case 0:
                if (mFromDatePicker != null)
                    mFromDatePicker.dispatchTouchEvent(event);
                break;
            case 1:
                if (mToDatePicker != null)
                    mToDatePicker.dispatchTouchEvent(event);
                break;
        }
